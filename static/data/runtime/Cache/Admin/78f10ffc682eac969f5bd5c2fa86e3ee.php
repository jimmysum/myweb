							...
							<td>
								<div  style="text-align: center;"><input type='hidden' name='smeta[thumb]' id='thumb' value="<?php echo ((isset($smeta["thumb"]) && ($smeta["thumb"] !== ""))?($smeta["thumb"]):''); ?>">
									<a href='javascript:void(0);' onclick="flashupload('thumb_images', '附件上传', 'thumb', thumb_images, '1,jpg|jpeg|gif|png|bmp,1,,,1', 'content', '12', 'b6ba209759e147124653ac77362ef2bd');
											return false;">
										<img src="<?php echo ((isset($smeta["thumb"]) && ($smeta["thumb"] !== ""))?($smeta["thumb"]):'/myweb/static/images/icon/upload-pic.png'); ?>" id='thumb_preview' width='135' height='113' style='cursor:hand' /></a>
									<input type="button" class="btn" onclick="crop_cut_thumb($('#thumb').val());
											return false;" value="裁减图片">  
			...
			<div class="col-auto">
				...
				<div class="table_full">
					<table width="100%">
						...
						<tr>
							<th width="80">模版</th>
							<td><input type='text' name='smeta[template]'  value="<?php echo ((isset($smeta["template"]) && ($smeta["template"] !== ""))?($smeta["template"]):'page'); ?>" style='width:280px'   class='input' placeholder='请输入模版'></td>
						</tr>
						<tr>
							<th width="80">关键词</th>
