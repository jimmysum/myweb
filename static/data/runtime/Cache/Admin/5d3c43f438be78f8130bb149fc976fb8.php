...
<html>
	...
	<style type="text/css">
		...
		.list-dot li a.close,.list-dot-othors li a.close{ background: url("/myweb/statics/images/cross.png") no-repeat left 3px; display:block; width:16px; height:16px;position: absolute;outline:none;right:5px; bottom:5px}
							...
							<td>
								<div  style="text-align: center;"><input type='hidden' name='slide_pic' id='thumb' value='<?php echo ($slide_pic); ?>'>
									<a href='javascript:void(0);' onclick="flashupload('thumb_images', '附件上传', 'thumb', thumb_images, '1,jpg|jpeg|gif|png|bmp,1,,,1', 'content', '12', 'b6ba209759e147124653ac77362ef2bd');
											return false;">
										<img src="<?php echo ((isset($slide_pic) && ($slide_pic !== ""))?($slide_pic):'/myweb/statics/images/icon/upload-pic.png'); ?>" id='thumb_preview' width='135' height='113' style='cursor:hand' /></a>
									<input type="button"  class="btn" onclick="$('#thumb_preview').attr('src', '/myweb/statics/images/icon/upload-pic.png');
											$('#thumb').val('');
